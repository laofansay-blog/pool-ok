					...
					<>
						...
						<View style={styles.balanceCard}>
							...
							<Pressable
								...
								onPress={() => router.push('/(modal)/recharge')}
							>
						...
						<View style={styles.menuSection}>
							...
							<Pressable
								style={styles.menuItem}
								onPress={() => router.push('/(modal)/stats')}
							>
							...
							<Pressable
								style={styles.menuItem}
								onPress={() => router.push('/(modal)/transactions')}
							>
							...
							<Pressable
								style={styles.menuItem}
								onPress={() => router.push('/(modal)/recharge-history')}
							>
							...
							<Pressable
								style={styles.menuItem}
								onPress={() => router.push('/(modal)/winnings')}
							>
